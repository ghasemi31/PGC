...
public partial class UserControl_MessageControl : System.Web.UI.UserControl
{
    ...
    public MessageType ReturnMsgType(string TXT)
    {
        foreach (char C in TXT)
            if (C >= MinFarsiCharCode && C <= MaxFarsiCharCode)
                return pgc.Model.Enums.MessageType.Persian;
        return pgc.Model.Enums.MessageType.Latin;
