<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_BranchReturnOrderTrust_List" %>
<legend><%=(this.Page as kFrameWork.UI.BasePage).Entity.Title %></legend>
<div class="list-help">
    <div class="commands">
        <a href="<%=ResolveUrl("~/Pages/Admin/ExcelReport/BranchReturnOrderListExcel.aspx")%>" target="_blank" class="excelbtn" >دریافت فایل اکسل نتایج</a>
        <a href="<%=ResolveUrl("~/Pages/Admin/Prints/BranchReturnOrderList.aspx")%>" target="_blank" class="printbtn" >چاپ نتایج</a>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:PersianDateColumnTemplate DataField="RegPersianDate" OriginalDataField="RegDate" HeaderText="تاریخ مرجوعی" />
