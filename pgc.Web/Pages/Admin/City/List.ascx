<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_City_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Province" HeaderText="استان" MaxLength="40"/>
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان" MaxLength="40"/>
