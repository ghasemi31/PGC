<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Admin_BranchOrderNoMoney_Detail" %>
...
<div class="commands">
    ...
    <a href="<%=ResolveUrl("~/Pages/Admin/Prints/BranchOrderNoMoneyDetail.aspx?id="+Order.ID.ToString() )%>" target="_blank" class="printbtn ocommands" >چاپ جزئیات</a>
