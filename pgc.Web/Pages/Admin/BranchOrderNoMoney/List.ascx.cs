...
public partial class Pages_Admin_BranchOrderNoMoney_List : BaseListControl
{
    ...
    protected void grdList_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if ((bool)DataBinder.Eval(e.Row.DataItem, "HasLack"))
            {
                ...
                h1.CssClass = "hbtn";
                h1.Target = "_blank";
                h1.NavigateUrl = ResolveClientUrl(GetRouteUrl("admin-branchlackordernomoney", null) + "?fid=" + DataBinder.Eval(e.Row.DataItem, "ID").ToString());
                h1.Text = "کسری";
