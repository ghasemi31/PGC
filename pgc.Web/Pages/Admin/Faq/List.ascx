<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Faq_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان سوال" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Summery" HeaderText="خلاصه" MaxLength="50"/>
