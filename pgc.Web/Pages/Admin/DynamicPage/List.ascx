<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_DynPage_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان صفحه" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="UrlKey" HeaderText="کلمه کلیدی url" MaxLength="20"/>
