<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchPaymentList.aspx.cs" Inherits="Pages_Admin_Prints_BranchPaymentList" %>
...
<head runat="server">
    <title>لسیت پرداختی های شعبه</title>
              ...
              <%try
                {
                          ...
                          !string.IsNullOrEmpty( pattern.Title) ) {%>
                                    <table border="0px" class="lsttbl">
                                        <tr class="thead" style="text-align:center;">
                                            <th colspan="2">نتایج جستجو بر روی فیلد های ذیل در لیست پرداختی های شعب</th>
                                        </tr>
                    ...
                    <%}else{ %>
                        <table border="0px" class="lsttbl">
                            <tr class="thead" style="text-align:center;">
                                <th>لیست تمامی پرداخت های شعب</th>
                            </tr>
                        </table>
                    <%} %>
