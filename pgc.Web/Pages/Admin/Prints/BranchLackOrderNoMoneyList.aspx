<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchLackOrderNoMoneyList.aspx.cs" Inherits="Pages_Agent_Prints_BranchLackOrderNoMoneyList" %>
                    ...
                    <%if (pattern.Branch_ID > 0 ||
                          ...
                          !string.IsNullOrEmpty( pattern.Title) ) {%>
                                <table border="0px" class="lsttbl">
                                    ...
                                    <tr>
                                        <% if (pattern.ID>0){ %>
                                            <td class="caption" style="border:none">کد کسری : <%=pattern.ID %></td>
                                        <%} %>
                                        <% if (pattern.BranchOrder_ID>0){ %>
                                            <td class="caption" style="border:none">کد درخواست : <%=pattern.BranchOrder_ID%></td>
                                        <%} %>  
                                    </tr>                                    
                                    <tr>
                                        ...
                                        <%if (BasePattern.IsEnumAssigned(pattern.Status)){ %>
                                            <td class="caption"style="border:none">وضعیت کسری : <%=EnumUtil.GetEnumElementPersianTitle(pattern.Status) %></td>
                                        <%} %>
                                    </tr>
                                    <tr>
