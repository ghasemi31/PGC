<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchTransactionList.aspx.cs" Inherits="Pages_Admin_Prints_BranchTransactionList" %>
...
<head runat="server">
    <title>لیست دریافتی و پرداختی ها</title>
              ...
              <%try
                {
                    ...
                    <%foreach (BranchTransaction item in OrdersList)
                    {
                        ...
                        <tr class="<%=(isAltRow)?"altrow":"row" %>">
                            <td><%=TotalNumber%></td>                            
                            <td><%=item.Branch.Title.Replace("شعبه","")%></td>
