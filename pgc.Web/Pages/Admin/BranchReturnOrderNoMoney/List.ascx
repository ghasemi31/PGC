<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_BranchReturnOrderNoMoney_List" %>
...
<div class="list-help">
    <div class="commands">
        ...
        <a href="<%=ResolveUrl("~/Pages/Admin/Prints/BranchReturnOrderNoMoneyList.aspx")%>" target="_blank" class="printbtn" >چاپ نتایج</a>
