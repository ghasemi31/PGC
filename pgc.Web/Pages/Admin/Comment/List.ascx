<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Comment_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="SenderEmail" HeaderText="پست الکترونیک"/>
        <kfk:TextColumnTemplate DataField="Body" HeaderText="متن" MaxLength="50"/>
