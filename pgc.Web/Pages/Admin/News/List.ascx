<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_News_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان خبر" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Summary" HeaderText="خلاصه خبر" MaxLength="50"/>        
