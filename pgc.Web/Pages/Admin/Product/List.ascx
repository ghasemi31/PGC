<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Product_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان محصول" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Body" HeaderText="توضیحات" MaxLength="50"/>
