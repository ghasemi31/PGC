<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Pages_Admin_SideMenuItem_Search" %>
<legend>جستجو</legend>
<table>
    <tr>
        <td class="caption">دسته بندی</td>
        <td class="control"><kfk:LookupCombo ID="lkpSideMenuCat" 
                                            runat="server" 
                                            BusinessTypeName="pgc.Business.Lookup.SideMenuCatLookupBusiness"
