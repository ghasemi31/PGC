<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_SideMenuItem_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="SideMenuCat" HeaderText="دسته بندی" MaxLength="30"/>
        <kfk:TextColumnTemplate DataField="NavigateUrl" HeaderText="آدرس لینک" MaxLength="20"/>
        <asp:TemplateField HeaderText="وضعیت نمایش">
            <ItemTemplate>
                <img src="/Styles/Images/<%# ((bool)Eval("IsVisible"))?"Enabled.png":"Disabled.png"	%>"/>              
            </ItemTemplate>
        </asp:TemplateField>
