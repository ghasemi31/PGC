<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/BaseEntityManagement.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Pages_Admin_Advertisement_Default" ValidateRequest="false" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_detail" Runat="Server">
    ...
    <div style="display:none" id="idiotmicrosoft">
