<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductSoldChartByBranch.aspx.cs" Inherits="Pages_Admin_Chart_ProductSoldChartByBranch" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="<%#ResolveUrl("~/Styles/Pages/Admin/Chart/ProductSoldChartByBranch.css") %>" />
        ...
        $(document).ready(function () {
            ...
            var plot1 = $.jqplot('chart1', [<%=dataSetArgument %>], {
                ...
                axes: {
                    ...
                    yaxis: {
                        pad: 1.1,
                        tickOptions: { formatString: "%'d عدد" },
                        labelRenderer: $.jqplot.CanvasAxisLabelRenderer
                    }
                },
                ...
                highlighter: {
                    ...
                    formatString: '<span style="display:none;">%d</span> %d عدد'
            ...
            //Click For More Information
                ...
                function (ev, seriesIndex, pointIndex, data) {
                    $('#info1').html('تعداد: '+parseInt( data.toString().split(',')[1]).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")+' عدد  -  '+$(tickList).val().split(',')[pointIndex]);
                }
            );
            ...
            $('tr.jqplot-table-legend td').first().click();
