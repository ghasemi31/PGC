<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OldProductSoldChart.aspx.cs" Inherits="Pages_Admin_Chart_ProductSoldChart" %>
        ...
        $(document).ready(function () {
            ...
            //Click For More Information
                ...
                function (ev, seriesIndex, pointIndex, data) {
                    ...
                    //$('#info1').html('تعداد: '+parseInt( data.toString().split(',')[1]).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")+' عدد');
                }
            );
