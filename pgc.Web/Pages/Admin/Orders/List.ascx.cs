...
public partial class Pages_Admin_GameOrder_List : BaseListControl
{
    ...
    protected void grdList_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        ...
        //    GameOrderPaymentStatus status = (pType == PaymentType.Presence) ?
        //                                GameOrderPaymentStatus.Presence :
        //                                (
        //                                (online.TransactionState == "OK" && online.ResultTransaction > 0 && online.RefNum != "") ?
        //                                GameOrderPaymentStatus.OnlineSucced :
        //                                GameOrderPaymentStatus.OnlineFailed
        //                                );

        //    switch (status)
        //    {
        //        case GameOrderPaymentStatus.Presence:
        ...
        //            break;
        //        case GameOrderPaymentStatus.Online:
        //        default:
        //            break;
        //    }
        ...
        {
            BaseManagementPage<GameOrdersBusiness, GameOrder, GameOrdersPattern, pgcEntities> page = (this.Page as BaseManagementPage<GameOrdersBusiness, GameOrder, GameOrdersPattern, pgcEntities>);
