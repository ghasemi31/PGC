<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/ControlPanel.master" AutoEventWireup="true" CodeFile="BranchOrder.aspx.cs" Inherits="Pages_Admin_BranchOrderByAdmin_BranchOrder" %>
...
<fieldset>
    ...
    <input type="hidden" id="SelectedMenuItem" value="<%= GetRouteUrl("admin-branchorderbyadmin",null) %>" />
