<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Article_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان مطلب" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Summary" HeaderText="خلاصه مطلب" MaxLength="50"/>
