<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/ControlPanel.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Pages_Admin_SMS_Default" %>
                ...
                <table id="SendMessage">
                    ...
                    <tr>
                        ...
                        <td class="control">
                            ...
                            <div><span style="padding-right:170px;" >تعداد شماره ها <strong><span id="numCount">0</span></strong></span></div>    
                        </td>
                    </tr>
                    </table>
                </div>
