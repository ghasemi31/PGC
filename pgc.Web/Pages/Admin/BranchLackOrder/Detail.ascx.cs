...
public partial class Pages_Admin_BranchLackOrder_Detail : BaseDetailControl<BranchLackOrder>
{
    ...
    {
        Response.Redirect(GetRouteUrl("admin-branchlackorderedit", null) + "?id=" + _Page.SelectedID);
    }
