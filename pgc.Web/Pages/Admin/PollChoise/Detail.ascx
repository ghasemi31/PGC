<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Admin_PollChoise_Detail" %>
<legend><%=(this.Page as kFrameWork.UI.BasePage).Entity.UITitle %></legend>
<table>
    <tr>
        <td class="caption">نظرسنجی</td>
        <td class="control"><kfk:LookupCombo ID="lkpPoll" 
                                            BusinessTypeName="pgc.Business.Lookup.PollLookupBusiness"
                                            runat="server" 
                                            Required="true" /></td>
    </tr>
    <tr>
