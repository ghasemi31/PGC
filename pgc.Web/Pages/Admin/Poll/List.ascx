<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Poll_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:BaseButtonField ButtonType="Button" CommandName="Choises" Text="گزینه ها" />
        <kfk:BaseButtonField ButtonType="Button" CommandName="Result" Text="نتایج" />
