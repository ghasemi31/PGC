<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Help_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان راهنما" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Body" HeaderText="متن راهنما" MaxLength="50"/>
