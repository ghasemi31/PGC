<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_GameCenter_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Description" HeaderText="توضیحات" MaxLength="80" />
          <kfk:TextColumnTemplate DataField="City" HeaderText="شهر" />
