...
public partial class Pages_Admin_BranchLackOrderNoMoney_Edit : BasePage
{
    ...
    public Pages_Admin_BranchLackOrderNoMoney_Edit()
    {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (opSuc.Result == ActionResult.Done)
        {
            ...
            if (this.HasValidQueryString<long>(QueryStringKeys.id))
                Response.Redirect(GetRouteUrl("admin-branchlackordernomoney", null) + "?id=" + branchLackOrder.ID);
            else
                Response.Redirect(GetRouteUrl("admin-branchlackordernomoney", null));
        }
    }
