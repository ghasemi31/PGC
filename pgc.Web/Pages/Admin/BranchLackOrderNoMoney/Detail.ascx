<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Admin_BranchLackOrderNoMoney_Detail" %>
...
<div class="commands">
    ...
    <a href="<%=ResolveUrl("~/Pages/Admin/Prints/BranchLackOrderNoMoneyDetail.aspx?id="+LackOrder.ID.ToString() )%>" target="_blank" class="printbtn ocommands" >چاپ جزئیات</a>
