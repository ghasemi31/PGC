<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_SocialIcon_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="نام شبکه اجتماعی" MaxLength="20" />
        <kfk:TextColumnTemplate DataField="Url" HeaderText="آدرس URL" MaxLength="100" />
        <kfk:TextColumnTemplate DataField="DispOrder" HeaderText="اولویت نمایش" MaxLength="5" />
