<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/ControlPanel.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Pages_Admin_BranchesOrderReport_Default" %>


<%@ Import Namespace="pgc.Model" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="/assets/css/BranchesOrderReport/Default.css" rel="stylesheet" />
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <fieldset id="list">
                ...
                <div style="padding: 0 0 20px 20px; float: left">
                    <a href="<%=ResolveUrl("~/Pages/Admin/ExcelReport/BranchesOrderReportExcel.aspx")%>" target="_blank" class="excelbtn">دریافت فایل اکسل نتایج</a>
                    <a href="<%=ResolveUrl("~/Pages/Admin/Prints/BranchesOrderReport.aspx")%>" target="_blank" class="printbtn ocommands">چاپ جزئیات</a>
                </div>
                <br />
                <br />
