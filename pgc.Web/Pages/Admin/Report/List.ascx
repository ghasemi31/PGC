<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Report_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان گزارش" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Summary" HeaderText="خلاصه گزارش" MaxLength="50"/>
