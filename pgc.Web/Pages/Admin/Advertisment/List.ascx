<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Advertisment_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Title" HeaderText="عنوان" MaxLength="20"/>
        <kfk:TextColumnTemplate DataField="Adv_Url" HeaderText="لینک" MaxLength="50"/>        
