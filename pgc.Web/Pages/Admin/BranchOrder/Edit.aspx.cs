...
public partial class Pages_Admin_BranchOrder_Edit : BasePage
{
    ...
    public Pages_Admin_BranchOrder_Edit()
    {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (opSuc.Result == ActionResult.Done)
        {
            ...
            if (this.HasValidQueryString<long>(QueryStringKeys.id))
                Response.Redirect(GetRouteUrl("admin-branchorder", null) + "?id=" + branchOrder.ID);
            else
                Response.Redirect(GetRouteUrl("admin-branchorder", null));
        }
    }
