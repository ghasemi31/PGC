...
public partial class Pages_Admin_BranchOrder_Detail : BaseDetailControl<BranchOrder>
{
    ...
    {
        Response.Redirect(GetRouteUrl("admin-branchorderedit", null) + "?id=" + _Page.SelectedID);
    }
