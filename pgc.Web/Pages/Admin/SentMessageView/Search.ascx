<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Pages_Admin_SentMessage_Search" %>
<legend>جستجو</legend>
<table>
    <tr>
        ...
        <td class="control"><kfk:LookupCombo ID="lkcSendStatus" 
                                runat="server" 
                                EnumParameterType="pgc.Model.Enums.SendSMSStatus" 
