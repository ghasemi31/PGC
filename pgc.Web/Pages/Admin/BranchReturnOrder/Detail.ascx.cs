...
public partial class Pages_Admin_BranchReturnOrder_Detail : BaseDetailControl<BranchReturnOrder>
{
    ...
    {
        Response.Redirect(GetRouteUrl("admin-branchreturnorderedit", null) + "?id=" + _Page.SelectedID);
    }  
}