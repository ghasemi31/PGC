<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Pages_Admin_BranchReturnOrder_Search" %>
<legend>جستجو</legend>
<table>
    <tr>
    ...
    <tr>
        ...
        <td class="control">
            <kfk:NormalTextBox Mode="Numeric" ID="txtID" runat="server" />
        </td>

        <td class="caption">وضعیت مرجوعی</td>
        <td class="control">
            <kfk:LookupCombo ID="lkpOrderStatus" runat="server" EnumParameterType="pgc.Model.Enums.BranchReturnOrderStatus" AddDefaultItem="true" />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="control">
            <kfk:NumericRange ID="nmrPrice" runat="server" />
        </td>

        <td class="caption">تاریخ مرجوعی</td>
        <td class="control">
            <kfk:PersianDateRange ID="pdrRegDate" runat="server" />
        </td>
    </tr>
</table>
<div class="commands">
