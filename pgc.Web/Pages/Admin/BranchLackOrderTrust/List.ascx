<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_BranchLackOrderTrust_List" %>
...
<div class="list-help">
    <div class="commands">
        ...
        <a href="<%=ResolveUrl("~/Pages/Admin/Prints/BranchLackOrderList.aspx")%>" target="_blank" class="printbtn" >چاپ نتایج</a>
