...
public partial class Pages_Admin_BranchLackOrderTrust_List : BaseListControl
{
    ...
    {
        int cellBranchOrder = 10;
        int cellLog = 9;
        int cellOrderedDate = 5;
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h2.CssClass = "hbtn";
            h2.Target = "_blank";
            h2.NavigateUrl = ResolveClientUrl(GetRouteUrl("admin-branchorder", null) + "?id=" + DataBinder.Eval(e.Row.DataItem, "BranchOrder_ID").ToString());
            h2.Text = "درخواست";
