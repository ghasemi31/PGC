...
public partial class Pages_Admin_BranchOrderedTitleNoMoney_Detail : BaseDetailControl<BranchOrderTitle>
{
    ...
    public override void SetEntity(BranchOrderTitle Data, ManagementPageMode Mode)
    {
        ...
        detailList.Controls.Add(_Page.Business.CreateBranchOrderedTitleNoMoneyBranchDetails(_Page.SelectedID, _Page.SearchControl.Pattern.PersianDate));
    }
}