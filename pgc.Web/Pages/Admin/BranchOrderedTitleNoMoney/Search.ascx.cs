...
public partial class Pages_Admin_BranchOrderedTitleNoMoney_Search : BaseSearchControl<BranchOrderedTitlePattern>
{
    ...
    public override BranchOrderedTitlePattern DefaultPattern
    {
        get
        {
            ...
            //long gID =0;
            //try
            //{gID = bgBus.Search_Where(bgBus.Context.BranchOrderTitleGroups, new BranchOrderTitleGroupPattern()).First().ID;}
            //catch (Exception ex)
            //{}
