<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Pages_Admin_EmailSendAttempt_Search" %>
<legend>جستجو</legend>
<table>
    <tr>
    ...
    <tr>
        ...
        <%--<td class="caption">ساعت ارسال</td>
        <td class="control"><kfk:TimePicker ID="tpTime" runat="server" /></td>      --%>  
    </tr>
