<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Admin_Branch_List" %>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="UrlKey" HeaderText="کلمه کلیدی url" MaxLength="30"/>
        <kfk:BaseBoundField DataField="DispOrder" HeaderText="اولویت نمایش"/>
        <kfk:BaseButtonField ButtonType="Button" CommandName="Pics" Text="عکس ها" />
        <kfk:BaseButtonField ButtonType="Button" CommandName="ActiveRow" Text="فعال سازی شعبه" />
        <kfk:BaseButtonField ButtonType="Button" CommandName="DeActiveRow" Text="تعلیق شعبه" />
