<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/ControlPanel.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Pages_User_UpdateProfile_Default" %>
...
<fieldset>
  ...
  <table>
    ...
    <tr>
        ...
        <td class="control"><kfk:NormalTextBox runat="server" ID="txtfName" Required="true"/></td>
