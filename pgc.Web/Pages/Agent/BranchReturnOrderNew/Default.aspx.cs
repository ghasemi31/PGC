...
public partial class Pages_Agent_BranchReturnOrderNew_Default : BasePage
{
    ViewStateCollection<BranchOrderTitleSelect> BranchOrderTitleSelectList;
    public BranchReturnOrder returnOrder;

    public Pages_Agent_BranchReturnOrderNew_Default()
    {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            if (this.HasValidQueryString<long>(QueryStringKeys.id))
                Response.Redirect(GetRouteUrl("agent-branchreturnorder", null) + "?id=" + branchReturnOrder.ID);
            else
    ...
    protected void btnCancle_Click(object sender, EventArgs e)
    {
        ...
        if (this.HasValidQueryString<long>(QueryStringKeys.id))
            Response.Redirect(GetRouteUrl("agent-branchreturnorder", null) + "?id=" + this.GetQueryStringValue<long>(QueryStringKeys.id));
        else
            Response.Redirect(GetRouteUrl("agent-branchreturnorder", null));
    }
