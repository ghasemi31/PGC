...
<body>        
   <form action="<%=ResolveUrl("http://localhost:8030/pages/agent/branchpaywizard/callbackurl.aspx") %>" method="post" ><%--<%=ResolveClientUrl(new pgc.Business.Core.SamanOnlinePayment().RedirectURL) --%>
