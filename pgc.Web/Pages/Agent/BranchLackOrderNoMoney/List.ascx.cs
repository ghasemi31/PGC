...
public partial class Pages_Agent_BranchLackOrderNoMoney_List : BaseListControl
{
    ...
    protected void grdList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            h.CssClass = "hbtn";
            h.Target = "_blank";
            h.NavigateUrl = ResolveClientUrl(GetRouteUrl("agent-branchordernomoney", null) + "?id=" + DataBinder.Eval(e.Row.DataItem, "BranchOrder_ID").ToString());
            h.Text = "درخواست";
