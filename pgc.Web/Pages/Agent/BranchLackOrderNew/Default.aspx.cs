...
public partial class Pages_Agent_BranchLackOrderNew_Default : BasePage
{
    ...
    public Pages_Agent_BranchLackOrderNew_Default()
    {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            if (this.HasValidQueryString<long>(QueryStringKeys.id))
                Response.Redirect(GetRouteUrl("agent-branchlackorder", null) + "?id=" + branchLackOrder.ID);
            else
    ...
    protected void btnCancle_Click(object sender, EventArgs e)
    {
        ...
        if (this.HasValidQueryString<long>(QueryStringKeys.id))
            Response.Redirect(GetRouteUrl("agent-branchlackorder", null) + "?id=" + this.GetQueryStringValue<long>(QueryStringKeys.id));
        else
            Response.Redirect(GetRouteUrl("agent-branchlackorder", null));
    }
