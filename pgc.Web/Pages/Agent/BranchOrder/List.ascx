<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Agent_BranchOrder_List" %>
...
<div class="list-help">
    <div class="commands">
        ...
        <a href="<%=ResolveUrl("~/Pages/Agent/Prints/BranchOrderList.aspx")%>" target="_blank" class="printbtn" >چاپ نتایج</a>
