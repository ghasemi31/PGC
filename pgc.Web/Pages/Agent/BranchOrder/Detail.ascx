<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Agent_BranchOrder_Detail" %>
...
<div class="commands">
    ...
    <a href="<%=ResolveUrl("~/Pages/Agent/Prints/BranchOrderDetail.aspx?id="+Order.ID.ToString() )%>" target="_blank" class="printbtn ocommands" >چاپ جزئیات</a>        
