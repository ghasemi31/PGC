<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Agent_BranchReturnOrder_List" %>
...
<div class="list-help">
    <div class="commands">
        ...
        <a href="<%=ResolveUrl("~/Pages/Agent/Prints/BranchReturnOrderList.aspx")%>" target="_blank" class="printbtn" >چاپ نتایج</a>
