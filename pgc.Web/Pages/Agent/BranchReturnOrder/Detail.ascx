<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Agent_BranchReturnOrder_Detail" %>
...
<div class="commands">
    ...
    <a href="<%=ResolveUrl("~/Pages/Agent/Prints/BranchReturnOrderDetail.aspx?id="+ReturnOrder.ID.ToString() )%>" target="_blank" class="printbtn ocommands" >چاپ جزئیات</a>        
