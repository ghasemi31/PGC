<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Pages_Agent_BranchOrderedTitle_Search" %>
<legend>جستجو</legend>
<table>
    <tr>
        ...
        <td class="control"><%=kFrameWork.UI.UserSession.User.Branch.Title %></td>
