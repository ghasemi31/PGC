<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Agent_BranchLackOrder_Detail" %>
...
<div class="commands">
    ...
    <a href="<%=ResolveUrl("~/Pages/Agent/Prints/BranchLackOrderDetail.aspx?id="+LackOrder.ID.ToString() )%>" target="_blank" class="printbtn ocommands" >چاپ جزئیات</a>        
