...
public partial class Pages_Agent_BranchLackOrder_Detail : BaseDetailControl<BranchLackOrder>
{
    ...
    {
        Response.Redirect(GetRouteUrl("agent-branchlackordernew", null) + "?id=" + _Page.SelectedID);
    }
