<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Pages_Agent_BranchFinanceLog_List" %>
...
<div class="list-help">
    <div class="commands">
        ...
        <a href="<%=ResolveUrl("~/Pages/Agent/Prints/BranchFinanceLog.aspx")%>" target="_blank" class="printbtn" >چاپ نتایج</a>
...
<kfk:HKGrid ID="grdList"
    ...
    <Columns>
        ...
        <kfk:TextColumnTemplate DataField="Description" HeaderText="توضیحات" MaxLength="60" />
