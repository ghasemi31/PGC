<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchPaymentDetail.aspx.cs" Inherits="Pages_Agent_Prints_BranchPaymentDetail" %>
              ...
              <%try
                {
                    ...
                    if (Pay.Branch_ID != kFrameWork.UI.UserSession.User.Branch_ID.Value)
                    ...
                    <table class="lsttbl" cellpadding="0" cellspacing="0">
                        <tr class="thead" style="text-align:center;">
                            <th colspan="2">اطلاعات شعبه</th>
                        </tr>    
                        <tr class="row">
                            <td>نام شعبه : <%=Pay.Branch.Title%></td>
    
                            <td>تلفن : <%=Pay.Branch.PhoneNumbers.Replace("\n","-")%></td>

                            <%--<td rowspan="2" width="120" class="logowrp"><img class="logo" src="http://pgcizi.com/UserFiles/images/112%20(1).gif"  alt="logo"/></td>--%>
                        </tr>
                        <tr class="altrow">
