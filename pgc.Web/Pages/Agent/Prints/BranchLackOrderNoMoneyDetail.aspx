<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchLackOrderNoMoneyDetail.aspx.cs" Inherits="Pages_Agent_Prints_BranchLackOrderNoMoneyDetail" %>
    ...
    <form id="form1" runat="server">
        <div>
              ...
              <%try
                ...
                {
                    Response.Redirect(GetRouteUrl("admin-branchlacknomoney", null));
                }%>
        </div>
    </form>
</body>
