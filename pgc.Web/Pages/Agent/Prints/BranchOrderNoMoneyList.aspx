<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchOrderNoMoneyList.aspx.cs" Inherits="Pages_Agent_Prints_BranchOrderNoMoneyList" %>
              ...
              <%try
                {
                    ...
                    <%if (pattern.Branch_ID > 0 || 
                          ...
                          !string.IsNullOrEmpty( pattern.Title) ) {%>
                                <table border="0px" class="lsttbl">
                                    <tr class="thead">
                                        <th style="text-align:center;" colspan="4">نتایج جستجو بر روی فیلد های ذیل در درخواست های شعبه</th>
                                    </tr>
                                    <tr>
                                        <%if (pattern.Branch_ID>0){ %>
