...
public partial class Pages_Agent_BranchTransaction_Detail : BaseDetailControl<BranchTransaction>
{
    ...
    public BranchTransaction transaction = new BranchTransaction();
