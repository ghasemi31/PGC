<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail.ascx.cs" Inherits="Pages_Agent_BranchTransaction_Detail" %>
...
<%if (transaction.TransactionType == (int)BranchTransactionType.BranchPayment && branchPay.Type == (int)BranchPaymentType.Offline){ %>
...
<%} %>
<%if (transaction.TransactionType == (int)BranchTransactionType.BranchPayment && branchPay.Type == (int)BranchPaymentType.Online){ %>
    <fieldset class="fieldsetDetail">
...
<%} %>
<%if ( transaction.TransactionType == (int)BranchTransactionType.CustomerOnline ){ %>
    <fieldset class="fieldsetDetail">
...
<%} %>
<%if ( transaction.TransactionType == (int)BranchTransactionType.BranchOrder ){ %>
    <fieldset class="fieldsetDetail">
        <legend class="legend lwrapper">فاکتور درخواست شعبه <%=transaction.Branch.Title %></legend>
        <table>
            <tr>        
...
<%} %>
<%if ( transaction.TransactionType == (int)BranchTransactionType.BranchLackOrder ){ %>
    <fieldset class="fieldsetDetail">
        <legend class="legend lwrapper">فاکتور کسری درخواست <%=transaction.Branch.Title %></legend>
        <table>
            <tr>
...
<%} %>
<%if ( transaction.TransactionType == (int)BranchTransactionType.BranchReturnOrder ){ %>
    <fieldset class="fieldsetDetail">
        <legend class="legend lwrapper">فاکتور مرجوعی <%=transaction.Branch.Title %></legend>
        <table>
            <tr>
