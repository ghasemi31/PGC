<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/Guest.master" AutoEventWireup="true" CodeFile="OrderList.aspx.cs" Inherits="Pages_Guest_OrderList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphStylePege" runat="Server">
    <%this.Title = (!string.IsNullOrEmpty(kFrameWork.UI.UserSession.User.FullName)) ? "لیست سفارشات من-" + kFrameWork.UI.UserSession.User.FullName : ""; %>
